drop program zzz_mpage_patientinfo:dba go
create program zzz_mpage_patientinfo:dba
...
head report
   ...
   sXML = concat(sXML, "<patientInfo_result>", p.name_full_formatted, "</patientInfo_result>")
   ...
   sXML = concat(sXML, "<patientInfo_result>", dob , "</patientInfo_result>")
   ...
   sXML = concat(sXML, "<patientInfo_result>", gender , "</patientInfo_result>")
