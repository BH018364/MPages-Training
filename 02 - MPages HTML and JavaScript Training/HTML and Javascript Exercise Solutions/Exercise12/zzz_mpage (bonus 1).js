	...
	docInfo.onreadystatechange = function () {
		if (docInfo.readyState == 4 && docInfo.status == 200) {
			...
			for (var i=0, dLen=doc_var.length;i<dLen;i++){
				...
				var paramStr = "$PAT_PERSONID$|$VIS_ENCNTRID$|"+doc_var2[2].text+"|Clinical Notes|31|CLINNOTES|341|CLINNOTES|1"
				...
				tableBody.push(
					"<tr>",
						...
						"<td class='diagnosticsCol2'><a href=\"javascript:MPAGES_EVENT( 'CLINICALNOTE', '"+paramStr+"')\";>",doc_var2[0].text,"</a></td>",
					"</tr>");
			}
