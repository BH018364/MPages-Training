drop program zzz_mpage_allergies:dba go
create program zzz_mpage_allergies:dba
...
head a.allergy_id
   ...
   sXML = concat(sXML, "<allergy>")
      ...
      sXML = concat(sXML, "<allergy_ftdesc>", BUILD(a.SUBSTANCE_FTDESC), "</allergy_ftdesc>") 
      sXML = concat(sXML, "<allergy_source>", BUILD(n.SOURCE_STRING), "</allergy_source>")
