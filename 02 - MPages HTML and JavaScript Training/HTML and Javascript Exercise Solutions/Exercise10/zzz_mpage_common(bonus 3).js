...
$(document).ready(function() {
   ...
   $('.colExp').click(function() {
		var colExpAllBtn = $(this),
			isExpanded = colExpAllBtn.html()=="-";
		colExpAllBtn.html((isExpanded)?"+":"-");
		$(".toggleButton").each(function(){
			var tglBtn = $(this);
			if ((tglBtn.html()=="-" && isExpanded) || (tglBtn.html()=="+" && !isExpanded)) {
				//collapse and expand only those that need it
				tglBtn.click();
			}
		});
   });
